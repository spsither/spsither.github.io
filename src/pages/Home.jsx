...
import { slogans, facts, timeline } from '../data/tibet'
...
/* Full-bleed image that drifts slowly behind the scroll. */
    ...
    <figure ref={ref} className="relative h-[70vh] overflow-hidden md:h-[85vh]">
      ...
      {caption && (
        <figcaption className="absolute bottom-8 left-0 w-full">
          <p className="container font-mono text-xs uppercase tracking-[0.2em] text-muted">
            {caption}
          </p>
        </figcaption>
      )}
...
export default function Home() {
  ...
  // The history timeline is long — show a few, expand for the rest.
    ...
    <main>
      ...
      >
        ...
        >
          ...
          >
            For more than seventy years, a people has refused to disappear.
            This is the story of Tibet — its occupation, its exile, and a
            freedom struggle carried in language, faith, and memory.
          </motion.p>
        ...
        <div className="absolute bottom-8 left-0 w-full">
          <p className="container font-mono text-[0.7rem] uppercase tracking-[0.3em] text-muted">
            ↓ Scroll
          </p>
        </div>
      </section>
      ...
      <section className="border-t border-line py-20 md:py-28">
        <div className="container">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="font-display text-hero font-black">
              If you watch one thing
            </h2>
            <p className="mx-auto mt-5 max-w-xl text-muted">
              {featuredSong.caption}
            </p>
          </Reveal>
      ...
      <div id="film">
        ...
        >
          <p>
            In March 1959, tens of thousands of Tibetans surrounded the
            Norbulingka palace in Lhasa to shield the 14th Dalai Lama from
            Chinese forces. The uprising was crushed; he fled across the
            Himalayas into exile in India, where he remains.
          </p>
          <p>
            Sixty-five years on, the struggle has not ended. This feature-length
            film follows a nation that lives in two places at once — scattered
            in exile, and holding on inside an occupied homeland — refusing to
            let its language, faith, and freedom be erased.
          </p>
        ...
        <div className="container">
          ...
          <div className="mt-14">
            {previewTimeline.map((t, i) => (
              <TimelineRow key={i} t={t} delay={(i % 3) * 0.05} />
            ))}
      ...
      <section className="relative overflow-hidden border-t border-line py-28 text-center md:py-40">
        ...
        <Reveal className="container relative">
          ...
          <p className="mx-auto mt-6 max-w-md text-muted">
            Learn the history. Share the story. Refuse the silence. Solidarity is
            the freedom struggle's longest road home.
          </p>
          <Link
            to="/contact"
